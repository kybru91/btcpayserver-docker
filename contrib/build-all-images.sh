...
# Build btcpayserver
# https://raw.githubusercontent.com/btcpayserver/btcpayserver/v2.4.1/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/btcpayserver/v2.4.1/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/btcpayserver/v2.4.1/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building btcpayserver/btcpayserver:2.4.1"
git clone https://github.com/btcpayserver/btcpayserver btcpayserver
cd btcpayserver
git checkout v2.4.1
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/btcpayserver:2.4.1" .
cd - && cd ..
...
# Build litecoin
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Litecoin/0.21.5.5/Litecoin/0.21.5.5/linuxamd64.Dockerfile
DOCKERFILE="Litecoin/0.21.5.5/linuxamd64.Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Litecoin/0.21.5.5/Litecoin/0.21.5.5/linuxarm32v7.Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Litecoin/0.21.5.5/linuxarm32v7.Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Litecoin/0.21.5.5/Litecoin/0.21.5.5/linuxarm64v8.Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Litecoin/0.21.5.5/linuxarm64v8.Dockerfile"
echo "Building btcpayserver/litecoin:0.21.5.5"
git clone https://github.com/btcpayserver/dockerfile-deps litecoin
cd litecoin
git checkout Litecoin/0.21.5.5
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/litecoin:0.21.5.5" .
cd - && cd ..
...
# Build nbxplorer
# https://raw.githubusercontent.com/dgarage/nbxplorer/v2.6.9/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/dgarage/nbxplorer/v2.6.9/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/dgarage/nbxplorer/v2.6.9/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building nicolasdorier/nbxplorer:2.6.9"
git clone https://github.com/dgarage/nbxplorer nbxplorer
cd nbxplorer
git checkout v2.6.9
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "nicolasdorier/nbxplorer:2.6.9" .
cd - && cd ..
...
# https://raw.githubusercontent.com/lightninglabs/lightning-terminal/v0.17.0-alpha/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/lightninglabs/lightning-terminal/v0.17.0-alpha/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building lightninglabs/lightning-terminal:v0.17.0-alpha-path-prefix"
git clone https://github.com/lightninglabs/lightning-terminal lightning-terminal
cd lightning-terminal
git checkout v0.17.0-alpha
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "lightninglabs/lightning-terminal:v0.17.0-alpha-path-prefix" .
cd - && cd ..
...
# Build pihole
# https://raw.githubusercontent.com/pi-hole/docker-pi-hole/2025.03.0/src/Dockerfile
DOCKERFILE="src/Dockerfile"
# https://raw.githubusercontent.com/pi-hole/docker-pi-hole/2025.03.0/src/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="src/Dockerfile"
# https://raw.githubusercontent.com/pi-hole/docker-pi-hole/2025.03.0/src/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="src/Dockerfile"
echo "Building pihole/pihole:2025.03.0"
git clone https://github.com/pi-hole/docker-pi-hole pihole
cd pihole
git checkout 2025.03.0
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "pihole/pihole:2025.03.0" .
cd - && cd ..
...
# Build thunderhub
# https://raw.githubusercontent.com/apotdevin/thunderhub/v0.15.4/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/apotdevin/thunderhub/v0.15.4/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/apotdevin/thunderhub/v0.15.4/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building apotdevin/thunderhub:base-0.15.4"
...
# https://raw.githubusercontent.com/btcpayserver/shopify-app/1.9/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/shopify-app/1.9/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/shopify-app/1.9/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building btcpayserver/shopify-app-deployer:1.9"
git clone https://github.com/btcpayserver/shopify-app shopify-app-deployer
cd shopify-app-deployer
git checkout 1.9
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/shopify-app-deployer:1.9" .
cd - && cd ..


# Build lightning
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v26.06.1-1/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v26.06.1-1/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v26.06.1-1/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building btcpayserver/lightning:v26.06.1-1"
git clone https://github.com/btcpayserver/lightning lightning
cd lightning
git checkout basedon-v26.06.1-1
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/lightning:v26.06.1-1" .
cd - && cd ..
...
echo "Building rachyand/taler-merchant:1.6.9"
git clone https://github.com/rachyandco/taler-btcpayserver-plugin taler-merchant
cd taler-merchant
git checkout master
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "rachyand/taler-merchant:1.6.9" .
cd - && cd ..
